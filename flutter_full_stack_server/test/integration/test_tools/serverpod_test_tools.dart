...
import 'package:flutter_full_stack_server/src/generated/greetings/greeting.dart'
    as _i73sut5t;
...
import 'package:flutter_full_stack_server/src/generated/endpoints.dart';
...
class _GreetingEndpoint {
  ...
  _ida.Future<_i73sut5t.Greeting> hello(
    _ist.TestSessionBuilder sessionBuilder,
    String name,
  ) async {
    return _ist.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        var _localReturnValue = await (_localCallContext.method.call(
          _localUniqueSession,
          _localCallContext.arguments,
        ) as _ida.Future<_i73sut5t.Greeting>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
