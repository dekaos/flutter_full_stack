...
--
-- MIGRATION VERSION FOR flutter_full_stack
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('flutter_full_stack', '20260906131331518-serverpod-4', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260906131331518-serverpod-4', "timestamp" = now();
