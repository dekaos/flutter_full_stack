...
import 'package:flutter_full_stack_client/src/protocol/greetings/greeting.dart'
    as _iypjfti3;
...
/// is made available on the server and enables automatic token refresh on
/// the client.
/// {@category Endpoint}
...
class EndpointGreeting extends _isc.EndpointRef {
  ...
  _ida.Future<_iypjfti3.Greeting> hello(String name) =>
      caller.callServerEndpoint<_iypjfti3.Greeting>(
        'greeting',
        'hello',
        {'name': name},
      );
